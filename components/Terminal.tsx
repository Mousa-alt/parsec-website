...
const COMMANDS: Record<string, () => TerminalLine[]> = {
  ...
  status: () => [
    ...
    { type: 'sys', text: '' },
    { type: 'info', text: '  ⚡ Deploy in days, not months' },
    { type: 'info', text: '  ⚡ At a fraction of the cost' },
  ],
  services: () => [
    { type: 'info', text: '╔═══════════════════════════════════════════════╗' },
  ...
  roi: () => [
    { type: 'info', text: '📊 THE PARSEC ADVANTAGE' },
    { type: 'sys', text: '──────────────────────────────────' },
    { type: 'success', text: '  ▸ Deployment:     Days, not months' },
    { type: 'success', text: '  ▸ Cost:           Fraction of traditional' },
    { type: 'success', text: '  ▸ Efficiency:     10x improvement' },
    { type: 'sys', text: '' },
    { type: 'sys', text: '  Typical Client Results:' },
    { type: 'success', text: '  ▸ Time Saved:     40+ hours/week' },
    { type: 'success', text: '  ▸ Cost Reduction: 60-80% operational' },
